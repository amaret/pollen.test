...
extern struct test68_Test_11_ test68_Test_11;
...
struct test68_Test_11_ {
    const uint8 NumEvents;
    struct test54_PrintImpl_ *pollenPrintProxy;
};
typedef struct test68_Test_11_ test68_Test_11_;

/*
 * ======== host variables (unit Test_11) ========
 */

typedef pollen_event_Event test68_Test_11_events__TYPE;
extern test68_Test_11_events__TYPE test68_Test_11_events__A[];

/*
 * ======== function members (unit Test_11) ========
 */

extern void test68_Test_11_tick4__I();
extern void test68_Test_11_pollen__run__E();
extern void test68_Test_11_tick3__I();
extern void test68_Test_11_tick2__I();
extern void test68_Test_11_tick1__I();
extern void test68_Test_11_pollen__shutdown__E( uint8 id );
extern void test68_Test_11_tick5__I();
extern void test68_Test_11_targetInit__I();
...
#define test68_Test_11_NumEvents (5)

/*
 * ======== data members (unit Test_11) ========
 */

#define test68_Test_11_NumEvents__V test68_Test_11.NumEvents
#define test68_Test_11_pollenPrintProxy__V test68_Test_11.pollenPrintProxy
