...
/*
 * ======== protocol member test68.Test_11.pollenPrintProxy delegates test54_PrintImpl ========
 */
...
#ifndef test68_Test_11__M
#define test68_Test_11__M
#include "../../test68/Test_11/Test_11.h"
#endif
...
test68_Test_11_events__TYPE test68_Test_11_events__A[] = {
    /* pollen.event.Event object init */
    {
        test68_Test_11_tick1__I,    /* eventHandler */
    },  /* [0] */
    /* pollen.event.Event object init */
    {
        test68_Test_11_tick2__I,    /* eventHandler */
    },  /* [1] */
    /* pollen.event.Event object init */
    {
        test68_Test_11_tick3__I,    /* eventHandler */
    },  /* [2] */
    /* pollen.event.Event object init */
    {
        test68_Test_11_tick4__I,    /* eventHandler */
    },  /* [3] */
    /* pollen.event.Event object init */
    {
        test68_Test_11_tick5__I,    /* eventHandler */
    },  /* [4] */
};
...
struct test68_Test_11_ test68_Test_11 = { /* module data */
...
void test68_Test_11_pollen__printBool(bool b) {
    test54_PrintImpl_printBool__E(b);
}
void test68_Test_11_pollen__printInt(int32 i) {
    test54_PrintImpl_printInt__E(i);
}
void test68_Test_11_pollen__printReal(float f) {
    test54_PrintImpl_printReal__E(f);
}
void test68_Test_11_pollen__printUint(uint32 u) {
    test54_PrintImpl_printUint__E(u);
}
void test68_Test_11_pollen__printStr(string s) {
...
#include "../../test68/Test_11/Test_11.c"
...
int main() {
    test68_Test_11_pollen__reset__E();
    ...
    test68_Test_11_targetInit__I();
    test68_Test_11_pollen__ready__E();
    test68_Test_11_pollen__run__E();
    test68_Test_11_pollen__shutdown__E(0);
}
