...
module PatternTest3 {
  ...
  host Scene sineScene = new Scene(60000, SinePattern.start, null)
  host Scene sineScene2 = new Scene(300, SinePattern.start, null)
  host Scene sineScene3 = new Scene(500, SinePattern.start, null)
  host Scene sineScene4 = new Scene(800, SinePattern.start, null)    
  host Scene sineScene5 = new Scene(1000, SinePattern.start, null)    
  host Scene sineScene6 = new Scene(400, SinePattern.start, null)      
