...
extern struct test41_Blink2_ test41_Blink2;

/*
 * ======== struct module definition (unit Blink2) ========
 */

struct test41_Blink2_ {
};
typedef struct test41_Blink2_ test41_Blink2_;

/*
 * ======== function members (unit Blink2) ========
 */

extern void test41_Blink2_pollen__reset__E();
extern void test41_Blink2_pollen__run__E();
extern void test41_Blink2_pollen__shutdown__E( uint8 id );
extern void test41_Blink2_targetInit__I();
