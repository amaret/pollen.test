...
var $$c = function() {
    const Event = {};
    Event.Event = Event
    Event.$name = 'test11.Event';
    Event.pollen$used = 0;
    Event.Event$$id = 1;
    Event.Event = function(cn) {
        this.$$id = Event.Event$$id++;
        this.$$cname = cn ? cn : 'test11_Event_Event__'+this.$$id+'__S';
        this.$$tname = 'test11_Event_Event';
        this.$$uname = 'test11.Event';
        this.code = 0;
        this.handler = 0;
    }
    Event.Event.prototype = new $$Struct('test11.Event.Event');
...
$units['test11.HelloWorld'].pollen$used = true;
