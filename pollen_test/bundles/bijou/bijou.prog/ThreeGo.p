...
module ThreeGo {
  ...
  host Scene scenes[5] = { new Scene(1000, RgbColorWalk.start, RgbColorWalk.stop),
                           new Scene(6000, StillColorPattern.start, StillColorPattern.stop),
                           new Scene(6000, StillColorPattern.start, StillColorPattern.stop),
                           new Scene(6000, StillColorPattern.start, StillColorPattern.stop),
                           new Scene(1000, RgbColorWalk.start, RgbColorWalk.stop) 
                         }
