...
target_vendor_id = 0x2323
target_product_id = 0x1111

devices = hid.HidDeviceFilter(vendor_id = target_vendor_id, product_id = target_product_id).get_devices()
...
if device.is_opened():
    ...
    print("Sending report: " + str(r))
    device.send_output_report(r)
    print("Closing..")
    device.close()
