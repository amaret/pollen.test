import AudioClassDeviceCommon

module MidiClassDeviceCommon {

  +{
    #ifndef __MidiClassDeviceCommon__P__
    #define __MidiClassDeviceCommon__P__ 
  }+
  ...
  +{ #endif /* __MidiClassDeviceCommon__P__ */ }+
}