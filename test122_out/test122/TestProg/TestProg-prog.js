...
/*
 * ======== MODULE test122.Module1 ========
 */

var $$c = function() {
    const Module1 = {};
    Module1.Module1 = Module1
    Module1.$name = 'test122.Module1';
    Module1.pollen$used = 0;
    Module1.foo = new $$Ref('test122_Module1_foo__E');
    Module1.targetInit = new $$Ref('test122_Module1_targetInit__I');
    Module1.$$hostInit = function() {
        var $$text = '';
        return $$text;
    }
    Module1.pollen__uses__ = function() {
    }
    Module1.$$privateInit = function() {
    }
    return Module1;
}
var $$u = $$c();
$units['test122.Module1'] = $$u;
$units.push($$u);
...
$units['test122.TestProg'].pollen$used = true;
