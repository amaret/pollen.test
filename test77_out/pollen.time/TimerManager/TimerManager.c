...
static const char pollen_time_TimerManager__s__0[] = "in host constr numMsTimers= ";
static const char pollen_time_TimerManager__s__2[] = ")\n";
static const char pollen_time_TimerManager__s__1[] = "TimerManager registering milli timer (total=";
...
void pollen_time_TimerManager_stop__E() {
    if (virtual_mcu_TimerMilli_isRunning__E()) {
        virtual_mcu_TimerMilli_stop__E();
    }
}

void pollen_time_TimerManager_start__E() {
    if (!virtual_mcu_TimerMilli_isRunning__E()) {
        virtual_mcu_TimerMilli_start__E();
    }
}

bool pollen_time_TimerManager_isActive__E() {
    return(  virtual_mcu_TimerMilli_isRunning__E()  );
}
